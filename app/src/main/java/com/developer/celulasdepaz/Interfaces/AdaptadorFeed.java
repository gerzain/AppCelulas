...
/**
 * Created by Irving on 19/11/2016.
 */
public class AdaptadorFeed extends ArrayAdapter<Facebook> {

    ArrayList<Facebook> actorList;
    LayoutInflater vi;
    int Resource;
    ViewHolder holder;

    public AdaptadorFeed(Context context, int resource, ArrayList<Facebook> objects) {
